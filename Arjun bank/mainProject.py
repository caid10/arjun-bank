...
def transaction(identity, amount, choice):  # choice 1 for deposit; choice 2 for withdraw
    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            ...
            if choice == 2 and balance - amount < 1000000:  # Minimum balance 1000000
                return -1
            else:
                if choice == 1:
                    balance += amount
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to Arjun BANK")
...
class depositMoney:
    ...
    def submit(self, amount):
        ...
        if output == -1:
            ...
            output = "Amount of usd " + str(amount) + " deposited successfully.\nUpdated balance : " + str(output)
...
class withdrawMoney:
    ...
    def submit(self, amount):
        ...
        if output == -1:
            ...
            output = "Amount of usd " + str(amount) + " withdrawn successfully.\nUpdated balance : " + str(output)
            customerMenu.printMessage_outside(output)
            self.master.withdraw()
